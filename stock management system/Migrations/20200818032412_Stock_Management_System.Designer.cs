...
namespace stock_management_system.Migrations
{
    ...
    [Migration("20200818032412_Stock_Management_System")]
            ...
            modelBuilder.Entity("stock_management_system.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2020, 8, 18, 3, 24, 11, 639, DateTimeKind.Utc).AddTicks(1766),
                            Description = "Productos para el consumo de la gente",
                            Name = "Insumos",
                            Updated = new DateTime(2020, 8, 18, 3, 24, 11, 639, DateTimeKind.Utc).AddTicks(1771)
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2020, 8, 18, 3, 24, 11, 639, DateTimeKind.Utc).AddTicks(5505),
                            Description = "Productos para la higiene de la casa",
                            Name = "Limpieza",
                            Updated = new DateTime(2020, 8, 18, 3, 24, 11, 639, DateTimeKind.Utc).AddTicks(5513)
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2020, 8, 18, 3, 24, 11, 639, DateTimeKind.Utc).AddTicks(5774),
                            Description = "Para el cuidado de la higiene personal",
                            Name = "Higiene",
                            Updated = new DateTime(2020, 8, 18, 3, 24, 11, 639, DateTimeKind.Utc).AddTicks(5778)
                        });
                });
            ...
            modelBuilder.Entity("stock_management_system.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2020, 8, 18, 3, 24, 11, 637, DateTimeKind.Utc).AddTicks(6904),
                            Email = "2018-0133@est.itsc.edu.do",
                            Lastname = "Tremols",
                            Name = "Juan",
                            Phone = 8097057474L,
                            Updated = new DateTime(2020, 8, 18, 3, 24, 11, 637, DateTimeKind.Utc).AddTicks(6917)
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2020, 8, 18, 3, 24, 11, 639, DateTimeKind.Utc).AddTicks(373),
                            Email = "pedroreyes@gmail.com",
                            Lastname = "Reyes",
                            Name = "Pedro",
                            Phone = 8097057424L,
                            Updated = new DateTime(2020, 8, 18, 3, 24, 11, 639, DateTimeKind.Utc).AddTicks(378)
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2020, 8, 18, 3, 24, 11, 639, DateTimeKind.Utc).AddTicks(521),
                            Email = "gabrielwakanda@gmail.com",
                            Lastname = "Wakanda",
                            Name = "Gabriel",
                            Phone = 8093057474L,
                            Updated = new DateTime(2020, 8, 18, 3, 24, 11, 639, DateTimeKind.Utc).AddTicks(523)
                        });
                });
            ...
            modelBuilder.Entity("stock_management_system.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            AlertQuantity = 5,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2020, 8, 18, 3, 24, 11, 640, DateTimeKind.Utc).AddTicks(3719),
                            Description = "Una paquete de papitas de dorito original pequeñas",
                            Name = "Papita doritos original",
                            PhotoUri = "https://images-na.ssl-images-amazon.com/images/I/81S5rKXF10L._SY879_.jpg",
                            Quantity = 10,
                            SellingPrice = 350,
                            Units = 25,
                            Updated = new DateTime(2020, 8, 18, 3, 24, 11, 640, DateTimeKind.Utc).AddTicks(3723)
                        },
                        new
                        {
                            Sku = "IS000003",
                            AlertQuantity = 5,
                            CategoryId = 3,
                            CreatedDate = new DateTime(2020, 8, 18, 3, 24, 11, 640, DateTimeKind.Utc).AddTicks(3859),
                            Description = "Una paquete de pasta dental colgate en tamaño pequeñas",
                            Name = "Pasta dental colgate pequeña",
                            PhotoUri = "https://papeleria-y-cacharreria-la-economia.000webhostapp.com/img/productos/crema%20_colgate_peque%C3%B1a.jpg",
                            Quantity = 5,
                            SellingPrice = 500,
                            Units = 10,
                            Updated = new DateTime(2020, 8, 18, 3, 24, 11, 640, DateTimeKind.Utc).AddTicks(3860)
                        });
                });
            ...
            modelBuilder.Entity("stock_management_system.Models.Supplier", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2020, 8, 18, 3, 24, 11, 639, DateTimeKind.Utc).AddTicks(6747),
                            Email = "colgaishon@est.itsc.edu.do",
                            Name = "Compañia de higiene personal colgaishon",
                            Phone = 8097057424L,
                            Updated = new DateTime(2020, 8, 18, 3, 24, 11, 639, DateTimeKind.Utc).AddTicks(6751)
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2020, 8, 18, 3, 24, 11, 639, DateTimeKind.Utc).AddTicks(8651),
                            Email = "fritolay@est.itsc.edu.do",
                            Name = "Compañia de insumos papita y bebida",
                            Phone = 8094677424L,
                            Updated = new DateTime(2020, 8, 18, 3, 24, 11, 639, DateTimeKind.Utc).AddTicks(8654)
                        });
                });
